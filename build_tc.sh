...
if [ "$STEP" == "libfdk-aac" ]; then
  ...
  compile libvpx "--target=x86_64-win64-vs15 --extra-cppflags="-Ithird_party/libyuv -Ithird_party/libwebm" --disable-shared --disable-examples --disable-tools --disable-docs"
